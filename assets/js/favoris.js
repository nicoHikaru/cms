      ...
      async function getAuteurs(){
         if(userId.value !== "none") {
            ...
            if(reponse.favoris === true) {
               //favoris.removeChild(fav);
               let svg = `
                  <svg xmlns="http://www.w3.org/2000/svg" id="fav" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
            ...
            if(reponse.favoris === false) {
               //favoris.removeChild(fav);
               let svg = `
                  <svg xmlns="http://www.w3.org/2000/svg" id="fav" width="20" height="20" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
